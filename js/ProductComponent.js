...
Vue.component('product', {
    ...
    <div class="product-cards-item-image">
        <img class="product-cards-item-image-img" :src="img" alt="product-card">
        <div class="product-cards-item-image-darken">
            <button @click="$root.$refs.cart.addProduct(product)" class="product-cards-item-image-darken-button">
    ...
    <p class="product-cards-item-name">{{product.product_name}}</p>
    ...
    <p class="product-cards-item-name-price">{{product.price}} $</p>
</div>
    `
});